...
work). The cross-model orchestration lives in this plugin's
`scripts/review-pr` helper — that's where the reviewer sub-agent is spawned
and findings are routed into a handoff file + local review comments. The skill
